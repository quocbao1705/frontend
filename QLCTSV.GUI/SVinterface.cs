...
namespace QLCTSV.GUI
{
    public partial class SVinterface: Form
    {
        ...
        private void button_diem_Click_1(object sender, EventArgs e)
        {
            OpenChildForm(new ThongtinSV(), sender);
        }

        private void button_hocbong_Click_1(object sender, EventArgs e)
        {
            OpenChildForm(new KQhoctapSV(), sender);
        }
